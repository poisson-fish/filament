...
## Progress Log
- 2026-02-26: Added markdown hardening regression vectors across server core and web client for obfuscated disallowed link schemes, malformed markdown token payload rejection, and oversized fenced-code language/code field validation; refreshed API and gateway docs for markdown/link sanitization and profile banner cache-bump handling.
