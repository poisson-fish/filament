...
- FE-01 latest: slice 27 completed on 2026-02-13 (extracted panel-host grouped state option composition from `create-app-shell-runtime.ts` into `runtime/panel-host-prop-groups-options.ts` and wired runtime usage with focused unit tests).
