...
- FE-01 latest: slice 25 completed on 2026-02-13 (extracted support panel-group state option composition from `create-app-shell-runtime.ts` into `runtime/support-panel-prop-groups-options.ts` and wired runtime usage with focused unit tests).
