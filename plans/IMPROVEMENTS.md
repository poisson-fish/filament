...
- FE-01 latest: slice 23 completed on 2026-02-12 (extracted panel-host prop-group composition into `runtime/panel-host-prop-groups.ts` and wired runtime usage with focused unit tests).
