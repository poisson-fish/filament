...
Item Status
- FE-01: In progress (slice 1 completed on 2026-02-12: extracted overlay/settings panel actions from `create-app-shell-runtime.ts` into `runtime/overlay-panel-actions.ts` with focused unit tests).
