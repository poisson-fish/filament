...
- FE-01 latest: slice 31 completed on 2026-02-13 (extracted panel-host prop-group factory wiring from `create-app-shell-runtime.ts` into `runtime/panel-host-prop-groups-factory.ts` and wired runtime usage with focused unit tests).
