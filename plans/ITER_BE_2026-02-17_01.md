...
#### 1) AppState Decomposition (Next Layer)
...
#### 2) Hardening + Performance Characterization Tests
...
1. AppState decomposition follow-ups
2. Hardening/perf characterization tests
