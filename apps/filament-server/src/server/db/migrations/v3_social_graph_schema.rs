...
const CREATE_GUILD_BANS_TABLE_SQL: &str = "CREATE TABLE IF NOT EXISTS guild_bans (
...
mod tests {
    ...
    fn social_graph_schema_statements_define_required_tables_and_indexes() {
        ...
        assert!(CREATE_FRIENDSHIP_REQUESTS_TABLE_SQL
        ...
        assert!(CREATE_FRIENDSHIP_REQUESTS_RECIPIENT_INDEX_SQL
