...
import { decodeWorkspaceRoleAssignmentGatewayEventPayload } from "./gateway-workspace-role-assignment-payload-events";
import {
...
const WORKSPACE_ROLE_EVENT_DECODERS: {
  ...
  workspace_role_assignment_add: (payload) =>
    decodeWorkspaceRoleAssignmentGatewayEventPayload("workspace_role_assignment_add", payload),
