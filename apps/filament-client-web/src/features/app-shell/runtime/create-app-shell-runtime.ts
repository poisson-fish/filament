    ...
    createPanelHostPropGroups(
      ...
      support: {
        ...
        selectedAvatarFilename: () =>
          profileState.selectedProfileAvatarFile()?.name ?? "",
        isSavingProfile: profileState.isSavingProfile,
        isUploadingProfileAvatar: profileState.isUploadingProfileAvatar,
        ...
        setWorkspaceSettingsVisibility:
          workspaceChannelState.setWorkspaceSettingsVisibility,
        setWorkspaceSettingsStatus: workspaceChannelState.setWorkspaceSettingsStatus,
        setWorkspaceSettingsError: workspaceChannelState.setWorkspaceSettingsError,
      ...
      collaboration: {
        ...
        onAcceptIncomingFriendRequest:
          friendshipActions.acceptIncomingFriendRequest,
        onDismissFriendRequest: friendshipActions.dismissFriendRequest,
        onRemoveFriendship: friendshipActions.removeFriendship,
        searchQuery: discoveryState.searchQuery,
        isSearching: discoveryState.isSearching,
        hasActiveWorkspace: () => Boolean(selectors.activeWorkspace()),
        ...
        setSelectedAttachment: messageState.setSelectedAttachment,
        setAttachmentFilename: messageState.setAttachmentFilename,
        onDownloadAttachment: attachmentActions.downloadAttachment,
        ...
        overrideDenyCsv: diagnosticsState.overrideDenyCsv,
        isModerating: diagnosticsState.isModerating,
        hasActiveModerationWorkspace: () => Boolean(selectors.activeWorkspace()),
        hasActiveModerationChannel: () => Boolean(selectors.activeChannel()),
        canManageRoles: selectors.canManageRoles,
        ...
        onRunMemberAction: moderationActions.runMemberAction,
