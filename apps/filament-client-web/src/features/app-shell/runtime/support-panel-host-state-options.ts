...
export function createSupportPanelHostStateOptions(
  ...
  return {
    ...
    selectedBannerFilename: () =>
      options.profileState.selectedProfileBannerFile()?.name ?? "",
    ...
    isUploadingProfileBanner: options.profileState.isUploadingProfileBanner,
    ...
    setSelectedProfileBannerFile: options.profileState.setSelectedProfileBannerFile,
    ...
    onUploadProfileBanner: options.profileController.uploadProfileBanner,
    avatarUrlForUser: options.profileController.avatarUrlForUser,
    bannerUrlForUser: options.profileController.bannerUrlForUser,
